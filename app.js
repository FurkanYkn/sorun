    ...
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            $(".item-info-description").html(
                ...
                gender +
                "</span></p><p><strong>Uyruk: </strong><span>" +
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p><strong>İsmi: </strong><span>" +
                itemData.info.firstname +
                "</span></p><p><strong>Soy İsmi: </strong><span>" +
                itemData.info.lastname +
                "</span></p><p><strong>Doğum Tarihi: </strong><span>" +
                itemData.info.birthdate +
                "</span></p><p><strong>Lisansı: </strong><span>" +
                itemData.info.type +
                "</span></p><p style=\"font-size:11px\" "
            );
        } else if (itemData.name == "weaponapplicationform") {
            var gender = "Erkek";
            if (itemData.info.gender == 1) {
                gender = "Kadın";
            }
